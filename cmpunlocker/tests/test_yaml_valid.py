...
def test_required_keys_present():
    ...
    required = [
        ...
        "feature_unlocks.verified.pcie_gen4.addr",
        "feature_unlocks.verified.pcie_gen4.value",
        "feature_unlocks.experimental.nvlink_enable.addr",
        "feature_unlocks.experimental.nvlink_enable.value",
        "feature_unlocks.experimental.ecc_enable.addr",
        "feature_unlocks.experimental.ecc_enable.value",
        "gpu.device_ids",
        "elf.header_magic",
